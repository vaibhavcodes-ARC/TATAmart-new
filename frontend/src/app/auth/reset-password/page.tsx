        ...
        <div className="rounded-[40px] border border-zinc-200/60 bg-white/80 p-8 sm:p-10 shadow-2xl shadow-indigo-600/[0.03] backdrop-blur-2xl dark:border-zinc-800/80 dark:bg-zinc-900/80">
          {!submitted ? (
            <>
              <div className="text-center mb-8">
                ...
                <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400">
                  Ensure your node is secure with a strong key.
                </p>
              </div>
            ...
            <div className="text-center py-6">
              ...
              <h3 className="font-heading text-2xl font-black text-zinc-900 dark:text-white mb-3">Password Updated</h3>
              <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400 mb-8 leading-relaxed">
                Your enterprise node is now secured. You can safely sign back into your workspace.
              </p>
              <Link href="/auth/login" className="flex items-center justify-center gap-2 rounded-2xl bg-zinc-900 hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-200 dark:text-zinc-900 py-3.5 px-6 font-bold text-white transition-colors">
                Sign In Now
              </Link>
            </div>
          )}
